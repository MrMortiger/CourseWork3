...
public class MarketController implements Initializable {
    ...
    private List<Fruit> getData() {
        ...
        fruit = new Fruit();
        fruit.setName("Змішувач для кухні");
        fruit.setPrice(2.99);
        fruit.setImgSrc("/img/1.png");
        fruit.setColor("6A7324");
        fruits.add(fruit);

        fruit = new Fruit();
        fruit.setName("Постамент");
        fruit.setPrice(3.99);
        fruit.setImgSrc("/img/2.png");
        fruit.setColor("A7745B");
        fruits.add(fruit);

        fruit = new Fruit();
        fruit.setName("Раковина");
        fruit.setPrice(1.50);
        fruit.setImgSrc("/img/3.png");
